...
"C:\Program Files\7-Zip\7z.exe" a -r ..\%RELEASE_NAME% -w .\dist\* -mem=AES256

cd ..
"C:\Program Files\Amazon\AWSCLI\aws.exe" s3api put-object --bucket bebo-app --key repo/gst-cef/%FILENAME% --body %FILENAME%
"C:\Program Files\Amazon\AWSCLI\aws.exe" s3api put-object --bucket bebo-app --key repo/gst-cef/%RELEASE_NAME% --body %RELEASE_NAME%
